...
- `apps/server/src/app.ts` and `packages/runtime/src/store.ts` remain the
  ...
  Thread Evidence/Lifecycle, and complete Channel HTTP boundaries are now
  extracted; new
