...
- the Web run retained exactly one onboarding Thread, one credential
  ...
  150 KiB;
- the complete repository gate passes 2,364 regular tests: Root 126, CLI 205,
  Server 202, Web 532, Contracts 3, Runtime 1,268, and SDK 28. Architecture
  audits 1,019 production source files and 501 test files with zero cycles;
