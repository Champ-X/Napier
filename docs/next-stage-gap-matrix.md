...
- the Web run retained exactly one onboarding Thread, one credential
  ...
  150 KiB;
- the complete repository gate passes 2,354 regular tests: Root 126, CLI 205,
  Server 199, Web 528, Contracts 3, Runtime 1,265, and SDK 28. Architecture
  audits 1,015 production source files and 498 test files with zero cycles;
