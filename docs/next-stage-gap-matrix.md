...
- successful offline-wait trials completed in 3.248–3.767 seconds with mean
  ...
  3 Series and 18 Result/Ledger artifacts join the multi-restart evidence in
  the 86-artifact release set `f83d0736c3eb81d5...`;
- budget exhaustion, no-progress detection, and uncertain write recovery
  remain.
