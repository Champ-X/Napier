...
| --------------------------------- | -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P0 architecture and baseline      | In progress    | Checked architecture budgets now freeze production/test module growth, per-file maximum function complexity, root and extracted-domain public exports, workspace dependency direction, and two remaining Runtime components of 7 and 2 modules, down from 10 components and 54 cyclic Runtime modules to 9 cyclic modules. Seven CLI/Runtime cycles were removed through leaf domain models; the 133-declaration Contracts/RPC closure moved into five bounded execution domains; Event sink, client, mutation, and Store SPIs removed another 45 Runtime modules from cycles. These changes preserve the public API and the single authoritative Store. The local product-path budget covers built CLI startup/first token/completion, shared Runtime bootstrap, production read-tool latency, 1,000-event append/projection, observed RSS, and closed SQLite bytes/event. Continue decomposing Evaluation and Receipt Trust; extend performance budgets to external Providers, HTTP/browser paths, 10,000-event Threads, and enforced resource quotas.                                                                                                                                                                                                                                                                                    |
...
- `npm run check:architecture` analyzes 596 production and 340 test TypeScript
