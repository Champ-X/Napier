...
- `apps/server/src/app.ts` and `packages/runtime/src/store.ts` remain the
  ...
  Thread Evidence, and Channel Admin HTTP boundaries are now extracted; new
