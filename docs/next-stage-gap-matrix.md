...
- the Web run retained exactly one onboarding Thread, one credential
  ...
  150 KiB;
- the complete repository gate passes 2,368 regular tests: Root 126, CLI 207,
