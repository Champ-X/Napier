...
- A fresh default Agent also receives a read-only Browser schema plus
  ...
  actionable states into that same isolated-profile takeover. Existing-user
  Chrome relay, autonomous CAPTCHA solving or login submission, and
  restart-safe login state remain P0.
...
| P9 outcome benchmark              | In progress    | Coding, Workflow, SQLite/DataFrame Data, SQLite prompt-injection Security, restart/offline-wait/token-budget/Goal-no-progress Long-horizon, fixed-source Research, one real open-web Search/Fetch/Browser Research triad, and clean-state CLI UX cases now measure exact outcomes, tool protocols, Replay, privacy, durability, and offline evidence. The retained current-case open-web trial passed once in 39.646 seconds; seven retained two-trial DeepSeek families passed 2/2; multi-restart/offline-wait distributions retain Provider-error inconclusive outcomes; current-case budget passed 7/7; Goal no-progress retains one breaker pass and one model-divergence failure. These samples are not a cross-model superiority claim. Repeated open-web Research/freshness, broader Long-horizon/Security/UX recovery/Web onboarding, broader Coding/Workflow/Data, reference-project execution, and larger cross-model distributions remain.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
