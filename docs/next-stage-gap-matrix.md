...
- the runner retains matching blocked/waiting/paused/cancelled terminal
  ...
  five-trial Series and their twenty artifacts are retained in the
  65-artifact release set `9e3dc5318bdf3200...`;
