...
| --------------------------------- | -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P0 architecture and baseline      | In progress    | Checked architecture budgets now freeze production/test module growth, per-file maximum function complexity, root and extracted-domain public exports, workspace dependency direction, and one remaining 14-module Runtime import component, down from 10 components and 54 cyclic Runtime modules. Seven CLI/Runtime cycles were removed through leaf domain models; the 133-declaration Contracts/RPC closure moved into five bounded execution domains; Event sink, MCP client, and Subagent mutation SPIs then removed another 40 Runtime modules from cycles. These changes preserve the public API. The local product-path budget covers built CLI startup/first token/completion, shared Runtime bootstrap, production read-tool latency, 1,000-event append/projection, observed RSS, and closed SQLite bytes/event. Continue decomposing the Evaluation/evidence/Store component; extend performance budgets to external Providers, HTTP/browser paths, 10,000-event Threads, and enforced resource quotas.                                                                                                                                                                                                                                                                                                                      |
...
- the architecture gate now covers 595 production and 340 test modules with
  one 14-module Evaluation/evidence/Store component. Cyclic Runtime modules
  decreased from 54 to 14 and maximum SCC size decreased from 54 to 14;
...
- `npm run check:architecture` analyzes 595 production and 340 test TypeScript
