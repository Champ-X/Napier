...
| P9 outcome benchmark              | Started        | Three fixed CLI Coding cases now cover single-file repair, a multi-file LSP-guided API migration, and debugger-qualified JavaScript repair with repeated trials, Sandbox assertions, capability-completion qualification, distributions, and Ledger evidence. Real DeepSeek dogfood passed the single-file and multi-file outcomes, while exposing high tool-failure/repetition counts and one correctly inconclusive nested-Sandbox run. Broader repeated model distributions, non-nested scoring, broader Coding, and other domains remain.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
