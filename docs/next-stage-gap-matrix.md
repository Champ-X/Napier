...
- the Web run retained exactly one onboarding Thread, one credential
  ...
  150 KiB;
- the complete repository gate passes 2,380 regular tests: Root 133, CLI 212,
