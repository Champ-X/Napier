...
> 历史方案，归档于 2026-09-07。下文的版本、待办与验收目标仅代表原方案。
> “DESIGN.md v1.1、页面迁移待执行”已不代表当前状态；现行设计规范见
> [DESIGN.md](../../DESIGN.md)，文档入口见 [docs/README.md](../README.md)。
...
- [会话自动滚动](https://github.com/Champ-X/Napier/blob/b5195c15b5a4bb4ac09b48690d66b2c8cf4ce45c/apps/web/src/use-conversation-auto-scroll.ts)
