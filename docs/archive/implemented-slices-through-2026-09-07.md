...
> This accumulated implementation log preserves its original claims and measurements;
> they have not been revalidated against current code. See the
> [current gaps](../next-stage-gap-matrix.md) for the maintained status summary.
