...
> Archived on 2026-09-07 from `f5a5937b2333c1f9307ad0acbb6195d60dfa5492`.
> The original log accumulated changes under a single `0.1.0 / 2026-07-25` heading.
> That heading is retained as recorded, not as a verified release date for each entry.
> New entries belong in the [current changelog](../../CHANGELOG.md).
