...
/api/receipt-trust/anchors/directory/discover`, and `POST
/api/receipt-trust/anchors/{anchorId}/revoke` promote the trust-anchor list,
create request, public directory, verification, hosted discovery, revoke
...
and Web client. The compatibility fixture generated by
