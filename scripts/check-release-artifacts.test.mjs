...
async function createFixture() {
  ...
  for (const relative of [
    ...
    "scripts/sandbox-external-release-dispatch.mjs",
    "scripts/sandbox-external-release-dispatch-model.mjs",
    "scripts/sandbox-external-release-dispatch-state.mjs",
    "scripts/sandbox-external-release-visibility.mjs",
    "scripts/check-sandbox-external-release-dispatch.mjs",
    "scripts/github-actions-dispatch-io.mjs",
...
async function createPackageLockFixture(root) {
  ...
  await writeJson(path.join(root, "apps/server/package.json"), serverPackage);
