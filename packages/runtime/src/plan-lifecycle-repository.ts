...
import { withExecutionPlanBlueprintRecordPreviewHash } from "./execution-plan-blueprint-replay-projection.js";
import { verifyExecutionPlanBlueprintRecordReplayEventProjection } from "./execution-plan-blueprint-replay-verification.js";
...
export class PlanLifecycleRepository {
  ...
  async verifyExecutionPlanBlueprintRecordReplayEvent(
    ...
    const events = threadExists
      ? await this.host.listEvents(request.threadId)
      : [];
