      ...
      try {
        ...
        const bundle = createResearchBenchmarkLedgerBundle({
          ...
          expectedCitationEvidenceSha256:
            evidence.expectedCitationEvidenceSha256,
        ...
        return new BenchmarkCampaignRunner(options.outputDir).persistArtifacts<
          typeof bundle,
          ReturnType<typeof createResearchBenchmarkResult>
        >({
          bundle,
          ledgerFileName,
          ...
          verify: verifyResearchBenchmarkArtifacts,
          verificationError:
            "Research benchmark artifacts failed self-verification",
        });
      } finally {
