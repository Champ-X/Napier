...
- The composer, resume, and Run Lab evaluation actions now consume the same
  selected-model availability projection, disabling run-starting paths before
  an unconfigured provider can trigger a server request.
