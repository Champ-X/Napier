...
export default function ReceiptTrustPanel({
  ...
  async function signActivationSelectionRotationProposal(): Promise<void> {
    if (
      ...
      <section className="receipt-verifier">
        ...
        <section className="receipt-baseline-workbench" aria-labelledby="receipt-baseline-workbench-title">
          ...
          <div className="receipt-baseline-actions">
            ...
            <button
              type="button"
              disabled={!canSignActivationSelectionRotationProposal}
              onClick={() => void signActivationSelectionRotationProposal()}
            >
              <ShieldCheck size={10} aria-hidden="true" />
