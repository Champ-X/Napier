export const planCopy = {
  ...
  artifactActions: {
    ...
    verifyDataProfile: "Verify profile",
    verifyingDataProfile: "Verifying...",
    dataProfileVerifyInvalidJson: "Data profile JSON is invalid.",
    dataProfileVerificationStatuses: {
      valid: "Profile verified",
