...
const en = {
  ...
  preview: "Preview", previewing: "Previewing…", diff: "Diff", diffing: "Diffing…",
  reveal: "Reveal", revealing: "Revealing…",
  copyPath: "Copy path", copied: "Copied", copyFailed: "Could not copy the artifact path.",
  restore: "Restore", restoring: "Restoring…", apply: "Apply", applying: "Applying…",
...
const zh: LocaleOverride<typeof en> = {
  ...
  preview: "预览", previewing: "正在预览…", diff: "差异", diffing: "正在读取差异…",
  reveal: "在文件中显示", revealing: "正在定位…",
  copyPath: "复制路径", copied: "已复制", copyFailed: "无法复制产物路径。",
  restore: "恢复", restoring: "正在恢复…", apply: "应用", applying: "正在应用…",
