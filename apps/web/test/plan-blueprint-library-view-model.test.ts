...
describe("Plan blueprint library view model", () => {
  ...
  it("projects replay outcome model review receipts", () => {
    ...
    expect(planBlueprintOutcomeReviewReceipt(review)).toEqual({
      ...
      reviewEnvelopeSha256: "5".repeat(64),
  ...
  it("projects blueprint recommendation policy override retirement history receipts", () => {
    ...
    const proofBundle: ExecutionPlanBlueprintRecommendationPolicyOverrideRetirementHistoryProofBundle =
      {
        kind: "napier.execution-plan-blueprint-recommendation-policy-override-retirement-history-proof-bundle",
        schemaVersion: 1,
        apiVersion: "0.1.0",
        generatedAt: "2026-07-26T00:00:14.000Z",
        status: "divergent",
        diagnostics: ["retirement_set_divergent"],
        historyCount: 2,
        validHistoryCount: 2,
        ...
        historySetSha256: "4".repeat(64),
        portfolioSetBundleSha256: "5".repeat(64),
        currentOverrideSetBundleSha256: "6".repeat(64),
        retirementSetBundleSha256: "7".repeat(64),
        histories: [
          {
            index: 0,
            status: "valid",
            diagnostics: [],
            declaredContentSha256: history.contentSha256,
            recomputedContentSha256: history.contentSha256,
            declaredPortfolioSetSha256: history.portfolioSetSha256,
            declaredCurrentOverrideSetSha256: history.currentOverrideSetSha256,
            declaredRetirementSetSha256: history.retirementSetSha256,
            recomputedRetirementSetSha256: history.retirementSetSha256,
            ...
            latestRetiredAt: retirement.retiredAt,
            recomputedLatestRetiredAt: retirement.retiredAt,
            itemSha256: "8".repeat(64),
          },
          {
            index: 1,
            status: "valid",
            diagnostics: [],
            declaredContentSha256: "9".repeat(64),
            recomputedContentSha256: "9".repeat(64),
            declaredPortfolioSetSha256: history.portfolioSetSha256,
            declaredCurrentOverrideSetSha256: history.currentOverrideSetSha256,
            declaredRetirementSetSha256: "a".repeat(64),
            recomputedRetirementSetSha256: "a".repeat(64),
            retirementCount: 1,
            recomputedRetirementCount: 1,
            latestRetiredAt: retirement.retiredAt,
            recomputedLatestRetiredAt: retirement.retiredAt,
    ...
    expect(
      ...
      highlightedHistoryStatus: "valid",
  ...
  return {
    ...
    phaseWaves: [
      ...
      },
      {
        ...
        blockedStepIds: [],
        terminalStepIds: [],
        waveSha256: "2".repeat(64),
      },
      {
        index: 2,
        stepIds: ["audit"],
        pendingStepIds: ["audit"],
        readyStepIds: [],
        runningStepIds: [],
        blockedStepIds: [],
        terminalStepIds: [],
        waveSha256: "3".repeat(64),
      },
    ],
    activePhaseIndex: 0,
    parallelReadyStepIds: ["inspect"],
    phaseProjectionSha256: "4".repeat(64),
    revision: 1,
    createdAt: timestamp,
    updatedAt: timestamp,
  };
